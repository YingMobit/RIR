...
public class MachineGun : GunBase {
    ...
    public override void Shoot() {
        ...
        moveComponent.velocity = CursorAimer.Instance.AimDirection.ToVector3();
    ...
    protected override void FactoryInit() {
        ...
        bulletFactory.AddBuilder(new BulletBuilder<BulletLifeComponent>().Set(new(bulletConfigData.MaxLifeTime,0)))
                     .AddBuilder(new BulletBuilder<BulletMoveComponent>().Set(new(bulletConfigData.BulletSpeed,CursorAimer.Instance.AimDirection.ToVector3())))
